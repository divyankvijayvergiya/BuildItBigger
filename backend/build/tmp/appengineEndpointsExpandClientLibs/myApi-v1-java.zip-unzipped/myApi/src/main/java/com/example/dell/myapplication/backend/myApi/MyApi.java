...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-itbigger.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.dell.myapplication.backend.myApi.model.MyBean> {
